	...
	{#if show}
		<div class=" py-2.5 space-y-1.5">
			<div class="flex flex-col w-full">
				<div class=" mb-1 text-xs text-gray-500">{$i18n.t('Current Pawd')}</div>
				...
				<div class="flex-1">
					<input
						...
						placeholder={$i18n.t('Enter your current pawd')}
			...
			<div class="flex flex-col w-full">
				...
				<div class="flex-1">
					<input
						...
						placeholder={$i18n.t('Enter your new pawd')}
			...
			<div class="flex flex-col w-full">
				<div class=" mb-1 text-xs text-gray-500">{$i18n.t('Confirm Pawd')}</div>
				...
				<div class="flex-1">
					<input
						...
						placeholder={$i18n.t('Confirm your new pawd')}
						autocomplete="off"
						required
					/>
				</div>
